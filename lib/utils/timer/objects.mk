...
libsbiutils-objs-$(CONFIG_TIMER_SCR) += timer/scr_mtimer.o
...
carray-fdt_timer_drivers-$(CONFIG_FDT_TIMER_SCR) += fdt_timer_scr_mtimer
libsbiutils-objs-$(CONFIG_FDT_TIMER_SCR) += timer/fdt_timer_scr_mtimer.o
