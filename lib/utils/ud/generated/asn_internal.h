...
#define	CALLOC(nmemb, size)	basic_calloc(nmemb, size)
#define	MALLOC(size)	basic_malloc(size)
#define	REALLOC(oldptr, size)	basic_realloc(oldptr, size)
#define	FREEMEM(ptr)	basic_free(ptr)
#define snprintf
